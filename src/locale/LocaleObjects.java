...
public class LocaleObjects {
    public static void main(String[] args) {
        ...
        // trying to pass invalid code, lets see how constructors and forLanguageTag and builder handle it....
        l = new Locale("en","U&S");
        System.out.println(l); // en_U&S

        l = Locale.forLanguageTag("en-U&S");
        System.out.println(l); // en (it will ignore the invalid tag)

        l = new Locale.Builder().setRegion("U&S")
                .setLanguage("en")
                .build();

        System.out.println(l); // it will throw an exception IllFormedLocaleException
